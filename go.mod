module github.com/evorts/kevlars
...
replace github.com/mojocn/base64Captcha v1.3.6 => github.com/evorts/base64Captcha v1.0.0
...
require (
	...
	github.com/go-jose/go-jose/jose-util v0.0.0-20240226165647-31202557b449 // indirect
