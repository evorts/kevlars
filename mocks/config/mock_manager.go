...
// GetStringSliceOrElse provides a mock function with given fields: key, orElse
func (_m *Manager) GetStringSliceOrElse(key string, orElse []string) []string {
	ret := _m.Called(key, orElse)

	if len(ret) == 0 {
		panic("no return value specified for GetStringSliceOrElse")
	}
...
// Manager_GetStringSliceOrElse_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetStringSliceOrElse'
type Manager_GetStringSliceOrElse_Call struct {
	*mock.Call
}

// GetStringSliceOrElse is a helper method to define mock.On call
//   - key string
//   - orElse []string
func (_e *Manager_Expecter) GetStringSliceOrElse(key interface{}, orElse interface{}) *Manager_GetStringSliceOrElse_Call {
	return &Manager_GetStringSliceOrElse_Call{Call: _e.mock.On("GetStringSliceOrElse", key, orElse)}
}

func (_c *Manager_GetStringSliceOrElse_Call) Run(run func(key string, orElse []string)) *Manager_GetStringSliceOrElse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string))
	})
	return _c
...
func (_c *Manager_GetStringSliceOrElse_Call) Return(_a0 []string) *Manager_GetStringSliceOrElse_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Manager_GetStringSliceOrElse_Call) RunAndReturn(run func(string, []string) []string) *Manager_GetStringSliceOrElse_Call {
	_c.Call.Return(run)
	return _c
}
