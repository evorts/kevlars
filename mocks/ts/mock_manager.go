...
import (
	...
	ts "github.com/evorts/kevlars/ts"
)
...
func (_m *Manager) Renew() ts.Manager {
	...
	var r0 ts.Manager
	if rf, ok := ret.Get(0).(func() ts.Manager); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ts.Manager)
		}
	}
...
func (_c *Manager_Renew_Call) Return(_a0 ts.Manager) *Manager_Renew_Call {
	_c.Call.Return(_a0)
	return _c
}
