...
// Manager_DSN_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DSN'
type Manager_DSN_Call struct {
	*mock.Call
}

// DSN is a helper method to define mock.On call
func (_e *Manager_Expecter) DSN() *Manager_DSN_Call {
	return &Manager_DSN_Call{Call: _e.mock.On("DSN")}
}

func (_c *Manager_DSN_Call) Run(run func()) *Manager_DSN_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Manager_DSN_Call) Return(_a0 string) *Manager_DSN_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Manager_DSN_Call) RunAndReturn(run func() string) *Manager_DSN_Call {
	_c.Call.Return(run)
	return _c
}
